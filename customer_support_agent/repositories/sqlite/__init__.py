...
def create_or_get_customer(email:str,name:str |None=None,company:str|None=None)->dict[str,Any]:
    return _customer.create_or_get(email=email,name=name,company=company)

def get_customer_by_id(customer_id:int)->dict[str,Any] | None:
    return _customer.get_by_id(customer_id)

def get_customer_bu_email(email:str)->dict[str,Any] | None:
    return _customer.get_by_email(email)
