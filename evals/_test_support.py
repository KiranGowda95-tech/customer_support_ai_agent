...
DEFAULT_EVAL_GROQ_MODEL = "llama-3.3-70b-specdec"
...
def build_eval_llm(settings: Settings) -> InstructorBaseRagasLLM:
    """Builds a correctly routed native LLM engine for the modern Ragas framework."""
